...
export default function App() {
  ...
  const handleNext = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      if (hasSubSlides) {
        ...
        else if (subSlideIndex < slide.content.length - 1) {
  ...
  const currentContent = isDetailView ? slide.content[subSlideIndex] : null;
          ...
          {isDetailView && (
            <div className="w-full h-full flex flex-col lg:flex-row relative">
              ...
              <div className="lg:w-[45%] h-full bg-slate-950 p-12 lg:p-16 overflow-y-auto custom-scrollbar flex flex-col justify-center relative z-20 shadow-2xl">
                <div className="mb-6 flex items-center gap-3 text-blue-400">
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">
                    Detalle Técnico {subSlideIndex + 1}/{slide.content.length}
                  </span>
                </div>
                ...
                <div className="mt-8 flex gap-2">
                  <div className="h-1 w-full bg-slate-800 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${
                          ((subSlideIndex + 1) / slide.content.length) * 100
                        }%`,
                      }}
                    ></div>
                  </div>
              ...
              <div className="lg:w-[55%] h-full relative overflow-hidden">
                ...
                {/* Etiqueta Flotante */}
                <div className="absolute bottom-12 right-12 z-20 bg-black/60 backdrop-blur-xl border border-white/10 p-6 rounded-2xl max-w-sm">
